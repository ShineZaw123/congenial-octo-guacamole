...
class KeyPairWrapper:
    ...
    def __init__(self, ec2_client, key_file_dir, key_pair=None):
        """
        :param ec2_client: A Boto3 Amazon EC2 client. This low-level client is used
                          to invoke Amazon EC2 service actions.
        :param key_file_dir: The folder where the private key information is stored.
                             This should be a secure folder.
        :param key_pair: A Boto3 KeyPairInfo object. This is a low-level object that
                         wraps key pair information.
        """
    ...
    def create(self, key_name):
        ...
        :return: A Boto3 KeyPairInfo object that represents the newly created key pair.
        """
        try:
            response = self.ec2_client.create_key_pair(KeyName=key_name)
            self.key_pair = response["KeyPair"]
    ...
    def list(self, limit):
        ...
        """
        try:
            response = self.ec2_client.describe_key_pairs(MaxResults=limit)
